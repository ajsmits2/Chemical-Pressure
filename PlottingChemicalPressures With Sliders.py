...
#Creating new feature of creating unit cells
#the cell file contains vectors that show the unitcell
#    3.44351019722380      0.00000000000000      0.00000000000000
#   -1.72175509858544      2.98216730892546      0.00000000000000
#   0.00000000000000      0.00000000000000      5.81936224305046
            ...
            for j3 in range(-4, 5):
                for k1 in range(natoms_geo):
                    for k2 in range(natoms_coords):
                        ...
                        y2 = xyz[k2][1]
                        z2 = xyz[k2][2]
                        dist = ((x1-x2)**2 + (y1-y2)**2 + (z1-z2)**2)**0.5 #This filters out all objects that are on top of other objects should filter the number of atoms past this point
                        if(dist < 0.1): 
                            for i in range(0,1):
...
unitcellpoints=([0,0,0],[cellvalue0[0],cellvalue0[1],cellvalue0[2]],
                [0,0,0],[cellvalue1[0],cellvalue1[1],cellvalue1[2]],
                [0,0,0],[cellvalue2[0],cellvalue2[1],cellvalue2[2]],)
print(unitcellpoints)
